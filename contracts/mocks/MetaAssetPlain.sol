...
contract MetaAssetPlain is ERC1155Supply, Pausable, Ownable, ReentrancyGuard {
    ...
    function uri(uint256 _id) public view override returns (string memory) {
        require(_exists(), "MetaERC1155#uri: NONEXISTENT_TOKEN");
    ...
    function _exists() internal pure returns (bool) {
        return false;
    }
